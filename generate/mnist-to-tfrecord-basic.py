...
def convert_to(data_set, name: str, data_directory: str, num_shards: int = 1, sort=False):
    ...
    if sort:
        ...
        images = numpy.take(images, ind, axis=0)
...
def convert_to_tf_record(data_directory: str):
    ...
    mnist = input_data.read_data_sets(
        "../../datasets/MNIST_BALANCED/",
        reshape=False
    )
    # convert_to(mnist.validation, 'validation', data_directory)
    convert_to(mnist.train, 'train-complete-', data_directory, num_shards=5, sort=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data-directory',
        default='../../datasets/MNIST_BALANCED/',
